...
import 'package:tiktok_challenge/newsignup/NewSignUpFormScreen.dart';
...
final routerProvider = Provider((ref) {
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      if (!isLoggedIn) {
        if (state.subloc != NewSignUpForThreadScreen.routeURL &&
            state.subloc != LoginScreen.routeURL) {
          return NewSignUpForThreadScreen.routeURL;
        }
      }
      return null;
    },
    routes: [
      ...
      GoRoute(
        name: NewSignUpForThreadScreen.routeName,
        path: NewSignUpForThreadScreen.routeURL,
        builder: (context, state) => const NewSignUpForThreadScreen(),
      ),
      GoRoute(
